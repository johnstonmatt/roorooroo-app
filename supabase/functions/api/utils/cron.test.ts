...
Deno.test("intervalToCronExpression - edge cases", () => {
  ...
  assertThrows(
    () => intervalToCronExpression(30),
    Error,
    "Check interval must be at least 60 seconds",
  );
  assertThrows(
    () => intervalToCronExpression(-1),
    Error,
    "Check interval must be at least 60 seconds",
  );
...
Deno.test("validateCronJobConfig - invalid configs", () => {
  ...
  assertEquals(
    errors[0],
    "Check interval must be a number and at least 60 seconds",
  );
  ...
  assertEquals(
    errors[0],
    "Check interval cannot exceed 24 hours (86400 seconds)",
  );
});
