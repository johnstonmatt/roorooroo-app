...
const PhoneInput = React.forwardRef<HTMLInputElement, PhoneInputProps>(
  ({ 
    ...
    const [validation, setValidation] = React.useState<PhoneValidationResult>({ isValid: false })
    ...
    const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      const formattedValue = formatPhoneNumberAsYouType(inputValue, defaultCountry)
    ...
    const shouldShowValidation = hasBeenBlurred || (validateOnChange && displayValue.length > 0)
