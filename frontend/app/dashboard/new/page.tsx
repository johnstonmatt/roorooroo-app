        ...
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-orange-800">New Watcher</h1>
                <p className="text-xs text-orange-600">Set up a new website monitor</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-2xl mx-auto">
          <Card className="border-orange-200 shadow-lg">
            <CardHeader className="text-center">
              ...
              <CardTitle className="text-2xl text-orange-800">Create a New Watcher</CardTitle>
            ...
            <CardContent>
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-orange-600">Give your watcher a memorable name</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="border-orange-200 focus:border-orange-400"
                  />
                  <p className="text-xs text-orange-600">The webpage you want to monitor</p>
                </div>

                {/* Pattern to Watch */}
                <div className="space-y-2">
                  <Label htmlFor="pattern" className="text-orange-700 font-medium">
                    What to Watch For
                  </Label>
                  <Textarea
                    id="pattern"
                  ...
                  />
                  <p className="text-xs text-orange-600">Text or pattern that should trigger an alert</p>
                </div>

                {/* Pattern Type */}
                <div className="space-y-2">
                  <Label className="text-orange-700 font-medium">Pattern Type</Label>
                ...
                {/* Check Interval */}
                <div className="space-y-2">
                  <Label className="text-orange-700 font-medium">Check Frequency</Label>
          ...
          <Card className="mt-8 border-orange-200">
            ...
            <CardContent className="space-y-3 text-sm text-orange-700">
              <div>
                <strong>URL Tips:</strong> Use the exact page URL where the content appears. Avoid redirects when
                possible.
              </div>
              <div>
              ...
              <div>
                <strong>Testing:</strong> Start with a longer interval and adjust based on how often the site actually
                changes.
              </div>
            </CardContent>
          </Card>
